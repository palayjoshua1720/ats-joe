	...
	<div class="min-h-screen flex">
		...
		<div class="flex flex-col justify-center w-full md:w-1/2 px-8 py-12" style="background: linear-gradient(135deg, #c471f5 0%, #8360c3 100%);">
			<div class="max-w-md w-full mx-auto">
				...
				<!-- Keycode Form -->
				<form v-if="loginPending" @submit.prevent="handleKeycode" class="space-y-6">
					<!-- Keycode -->
...
const { email, password, loginPending, keycode, loading, error, handleLogin, handleKeycode } = useLogin()
